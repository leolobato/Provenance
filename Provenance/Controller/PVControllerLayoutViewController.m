//
//  PVControllerLayoutViewController.m
//  Provenance
//
...
@interface PVControllerLayoutViewController ()

@property (nonatomic, strong) NSArray *controlLayout;

@end

@implementation PVControllerLayoutViewController
...
- (id)initWithControlLayout:(NSArray *)controlLayout systemIdentifier:(NSString *)systemIdentifier
{
    if ((self = [super initWithNibName:nil bundle:nil]))
    {
        ...
        self.controllerOpacity = 1.0f;
        self.vibrationEnabled = NO;
    }
...
{
#if !TARGET_OS_TV
    CGFloat alpha = self.controllerOpacity;
